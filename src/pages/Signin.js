...
export default function Page() {  // Rename function to match the file name
  ...
  return (
    <SafeAreaView style={[styles.container , {height: height}]}>
      ...
      <View style={{marginTop: height > 900 && height < 920 ? 180 : height > 920? 50 :height > 740 && height < 899 ? 150 : 130}}></View>
      <View style={{ 
        flex: 1, 
        alignItems: "center", 
        justifyContent: "center", 
        paddingTop: height > 900 && height < 920 ? 130 : height > 920? 50 :height > 740 && height < 899 ? 237 : 130, 
